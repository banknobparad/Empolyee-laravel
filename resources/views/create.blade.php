...
@section('content')
    ...
    <form action="{{ route('create') }}" method="post">
        ...
        {{-- <form action="{{ route('create') }}" method="POST" enctype="multipart/form-data"  style="margin-top: 20px;">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input typ="name" name="depant_id" class="form-control" value="{{ old('depant_id') }}">
                </div>
